...
<!--  -->
			...
			<div class="panel panel-default">
				...
				<div class="list-group">
					<!--for 默认参数为-->
					<?php $__FOR_START_340331176__=0;$__FOR_END_340331176__=5;for($i=$__FOR_START_340331176__;$i < $__FOR_END_340331176__;$i+=1){ ?><a href="#" class="list-group-item">使用for标签循环了<?php echo ($i+1); ?>次了</a><?php } ?>
				</div>
			</div>
